...
| **Pretext text layout** (deterministic wrap/caption/living-doc overlays in the Remotion runtime) | npm `@chenglou/pretext@0.0.6` via `pmoves/services/a2ui-renderer/src/remotion/pretextLayout.ts`; [`Pmoves-pretext` fork](https://github.com/POWERFULMOVES/Pmoves-pretext) exists on GitHub but is NOT wired as a submodule | [`pmoves/docs/CREATOR_PIPELINE.md`](./pmoves/docs/CREATOR_PIPELINE.md) §text_layout |
