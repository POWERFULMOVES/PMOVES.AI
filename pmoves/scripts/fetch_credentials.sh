...
printenv | while IFS='=' read -r var value; do
  ...
  case "$var" in
    *_API_KEY|*_TOKEN|*_SECRET|*_PASSWORD|*_PRIVATE_KEY|*_CLIENT_ID|OPENAI_API_KEY|ANTHROPIC_API_KEY|GROQ_API_KEY|GEMINI_API_KEY|GOOGLE_API_KEY|GOOGLE_CLIENT_ID|MISTRAL_API_KEY|DEEPSEEK_API_KEY|OPENROUTER_API_KEY|XAI_API_KEY|ELEVENLABS_API_KEY|VOYAGE_API_KEY|COHERE_API_KEY|FIREWORKS_AI_API_KEY|PERPLEXITYAI_API_KEY|TOGETHER_AI_API_KEY|Z_AI_API_KEY|ALIBABA_PRO_CODING_PLAN|VENICE_API_KEY|CLOUDFLARE_API_TOKEN|CLOUDFLARE_ACCOUNT_ID|OLLAMA_BASE_URL|GH_APP_ID|GH_APP_CLIENT_ID|GH_APP_SEC|GH_APP_INSTALLATION_ID)
      if [ -n "$value" ]; then
...
TARGET_KEYS=("OPENAI_API_KEY" "ANTHROPIC_API_KEY" "GROQ_API_KEY" "GEMINI_API_KEY" "GOOGLE_API_KEY" "GOOGLE_CLIENT_ID" "GOOGLE_CLIENT_SECRET" "MISTRAL_API_KEY" "DEEPSEEK_API_KEY" "OPENROUTER_API_KEY" "XAI_API_KEY" "ELEVENLABS_API_KEY" "VOYAGE_API_KEY" "COHERE_API_KEY" "FIREWORKS_AI_API_KEY" "PERPLEXITYAI_API_KEY" "TOGETHER_AI_API_KEY" "Z_AI_API_KEY" "ALIBABA_PRO_CODING_PLAN" "VENICE_API_KEY" "CLOUDFLARE_API_TOKEN" "CLOUDFLARE_ACCOUNT_ID" "OLLAMA_CLOUD_API_KEY" "WGER_ADMIN_PASSWORD")
