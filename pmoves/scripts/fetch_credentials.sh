...
TARGET_KEYS=("OPENAI_API_KEY" "ANTHROPIC_API_KEY" "GROQ_API_KEY" "GEMINI_API_KEY" "GOOGLE_API_KEY" "MISTRAL_API_KEY" "DEEPSEEK_API_KEY" "OPENROUTER_API_KEY" "XAI_API_KEY" "ELEVENLABS_API_KEY" "VOYAGE_API_KEY" "COHERE_API_KEY" "FIREWORKS_AI_API_KEY" "PERPLEXITYAI_API_KEY" "TOGETHER_AI_API_KEY" "Z_AI_API_KEY" "ALIBABA_PRO_CODING_PLAN" "VENICE_API_KEY" "CLOUDFLARE_API_TOKEN" "CLOUDFLARE_ACCOUNT_ID")
