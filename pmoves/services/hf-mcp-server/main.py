...
MODEL_CATALOG: Dict[str, Dict[str, Any]] = {
    ...
    # Qwen 3.5 Family (March 2026 — multimodal, vision, tools, thinking)
    "qwen3.5-0.8b": {
    ...
    "qwen3.5-9b": {
        ...
        "quantization": "Q4_K_M",
        "tier": "medium",
        "uses": ["orchestrator", "coding", "utility", "research"],
        "backends": ["ollama", "vllm"],
    ...
    "qwen3.5-27b": {
        ...
        "quantization": "Q4_K_M",
        "tier": "large",
        "uses": ["orchestrator", "research", "coding"],
        "backends": ["ollama", "vllm"],
        "ollama_name": "qwen3.5:27b",
        "hf_url": "https://huggingface.co/Qwen/Qwen3.5-27B",
        "min_vram_mb": 17000,
    },
    "qwen3.5-35b-a3b": {
    ...
    "lfm2-24b-a2b": {
        ...
        "quantization": "Q4_K_M",
        "tier": "medium",
        "uses": ["utility", "orchestrator"],
        "backends": ["ollama"],
        "ollama_name": "lfm2:24b",
        "hf_url": "https://huggingface.co/LiquidAI/LFM2-24B-A2B",
        "min_vram_mb": 14000,
    },

    # Nemotron-3-Super (NVIDIA agentic MoE — multi-GPU only)
    "nemotron-3-super": {
        "model_id": "nvidia/Nemotron-3-Super-49B-v1",
        ...
        "uses": ["orchestrator", "research"],
        "backends": ["ollama", "vllm"],
        "ollama_name": "nemotron-3-super",
        "hf_url": "https://huggingface.co/nvidia/Nemotron-3-Super-49B-v1",
        "min_vram_mb": 70000,
    },
}
