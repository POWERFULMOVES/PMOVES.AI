...
grab "models/text_encoders/Qwen2.5-VL-7B-Instruct-UD-Q4_K_S.gguf"  "$HF_BASE/Qwen2.5-VL-7B-Instruct-UD-Q4_K_S.gguf?download=true"
grab "models/vae/qwen_image_vae.safetensors" "$HF_BASE/qwen_image_vae.safetensors?download=true"
grab "models/unet/Qwen-Image-Edit-2509-${MODEL_VERSION}.gguf" "$HF_BASE/Qwen-Image-Edit-2509-${MODEL_VERSION}.gguf?download=true"
grab "models/loras/Qwen-Image-Edit-Lightning-8steps-V1.0.safetensors" "$HF_BASE/Qwen-Image-Edit-Lightning-8steps-V1.0.safetensors?download=true"
grab "models/loras/Qwen-Image-Edit-Lightning-4steps-V1.0.safetensors" "$HF_BASE/Qwen-Image-Edit-Lightning-4steps-V1.0.safetensors?download=true"
