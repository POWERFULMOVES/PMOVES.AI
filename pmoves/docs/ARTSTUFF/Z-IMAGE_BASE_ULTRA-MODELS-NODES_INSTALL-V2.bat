...
rem ----------------------------------------------------------------
rem  Z-IMAGE V2 - SAFE node install + model fetch
...
rem
rem  Usage:
rem    Z-IMAGE-BASE-MODELS-NODES_INSTALL.bat
rem    Z-IMAGE-BASE-MODELS-NODES_INSTALL.bat /update
rem    Z-IMAGE-BASE-MODELS-NODES_INSTALL.bat /force
rem    Z-IMAGE-BASE-MODELS-NODES_INSTALL.bat /dryrun
rem    Z-IMAGE-BASE-MODELS-NODES_INSTALL.bat /restore
rem
...
:CHOOSE_MODEL
echo(
echo Which Z IMAGE BASE quantization?
...
:models_only
echo(
echo -------- Checking Z-IMAGE-BASE model files --------
pushd models
...
:: --- MODEL PATCHES ---
call :grab model_patches\Z-Image-Fun-Controlnet-Union-2.1.safetensors ^
     "%HF%/Z-Image-Fun-Controlnet-Union-2.1.safetensors?download=true"	

:: --- LORAS ---
call :grab loras\Z-Image-Fun-Lora-Distill-8-Steps_ComfyUI.safetensors ^
     "%HF%/Z-Image-Fun-Lora-Distill-8-Steps_ComfyUI.safetensors?download=true"	 
	 
:: --- UNets ---
call :grab unet\z_image_turbo-!MODEL_VERSION!.gguf ^
     "%HF%/z_image_turbo-!MODEL_VERSION!.gguf?download=true"
	 
call :grab unet\z_image-!MODEL_VERSION!.gguf ^
     "%HF%/z_image-!MODEL_VERSION!.gguf?download=true"	 
