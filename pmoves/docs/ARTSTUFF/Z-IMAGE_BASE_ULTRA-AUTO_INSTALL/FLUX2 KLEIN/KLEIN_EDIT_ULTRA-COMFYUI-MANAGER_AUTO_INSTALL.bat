...
rem -------------------------------------------------------------
rem  ComfyUI + FLUX  KLEIN 9B one-click installer V2      by Aitrepreneur
rem -------------------------------------------------------------

:: Version bump zone
set "COMFY_VER=v0.13.0"
...
call :clone https://github.com/chflame163/ComfyUI_LayerStyle
if exist ComfyUI_LayerStyle\requirements.txt "%PY%" -m pip install -r ComfyUI_LayerStyle\requirements.txt
...
echo(
echo -------- Downloading Z-IMAGE model files --------
