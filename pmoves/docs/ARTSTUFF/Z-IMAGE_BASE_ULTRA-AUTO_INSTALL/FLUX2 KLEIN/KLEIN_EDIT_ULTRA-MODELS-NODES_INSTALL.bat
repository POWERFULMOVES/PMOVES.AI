...
rem ----------------------------------------------------------------
rem  FLUX  KLEIN 9B - SAFE node install + model fetch
...
rem
rem  Usage:
rem    KLEIN_EDIT_ULTRA-MODELS-NODES_INSTALL.bat
rem    KLEIN_EDIT_ULTRA-MODELS-NODES_INSTALL.bat /update
rem    KLEIN_EDIT_ULTRA-MODELS-NODES_INSTALL.bat /force
rem    KLEIN_EDIT_ULTRA-MODELS-NODES_INSTALL.bat /dryrun
rem    KLEIN_EDIT_ULTRA-MODELS-NODES_INSTALL.bat /restore
rem
...
:CHOOSE_MODEL
echo(
echo Which Klein 9B quantization?
echo 1) Q4_K_S  - GPUs less than 12 GB VRAM
...
:: log header
call :timestamp TS
echo [%TS%] Starting Z-IMAGE-BASE safe installer. > "%LOG%"
...
call :handle_node "ComfyUI_LayerStyle"            "https://github.com/chflame163/ComfyUI_LayerStyle"
...
:: --- Text Encoders ---
call :grab text_encoders\qwen_3_8b_fp8mixed_abliterated.safetensors ^
     "%HF%/qwen_3_8b_fp8mixed_abliterated.safetensors?download=true"
  
:: --- VAE ---
call :grab vae\flux2-vae.safetensors ^
     "%HF%/flux2-vae.safetensors?download=true"
	 
:: --- LORAS ---
call :grab loras\KLEIN-DETAILER.safetensors ^
     "%HF%/KLEIN-DETAILER.safetensors?download=true"	

call :grab loras\detail_slider_klein_9b_20260123_065513.safetensors ^
     "%HF%/detail_slider_klein_9b_20260123_065513.safetensors?download=true"

call :grab loras\uncrop_F2K9B.safetensors ^
     "%HF%/uncrop_F2K9B.safetensors?download=true"

call :grab loras\anime2real-semi.safetensors ^
     "%HF%/anime2real-semi.safetensors?download=true"	 
	 	 
call :grab loras\darkBeastFeb1826Latest_dbkBlitzV15.safetensors ^
     "%HF%/darkBeastFeb1826Latest_dbkBlitzV15.safetensors?download=true"	 
	 	 
call :grab loras\lenovo_flux_klein9b.safetensors ^
     "%HF%/lenovo_flux_klein9b.safetensors?download=true"	 
	 
call :grab loras\nicegirls_flux_klein9b.safetensors ^
     "%HF%/nicegirls_flux_klein9b.safetensors?download=true"		 
	 
:: --- UNets ---
call :grab unet\flux-2-klein-9b-!MODEL_VERSION!.gguf ^
     "%HF%/flux-2-klein-9b-!MODEL_VERSION!.gguf?download=true"
	 	 
:: --- Diffusion models ---
call :grab diffusion_models\flux-2-klein-9b-fp8.safetensors ^
     "%HF%/flux-2-klein-9b-fp8.safetensors?download=true"
