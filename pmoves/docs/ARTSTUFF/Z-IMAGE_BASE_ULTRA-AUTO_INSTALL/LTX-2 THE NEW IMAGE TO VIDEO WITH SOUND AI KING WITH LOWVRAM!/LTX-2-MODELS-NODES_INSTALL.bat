...
rem ----------------------------------------------------------------
rem  LTX-2 - SAFE node install + model fetch
...
rem
rem  Usage:
rem    LTX-2-MODELS-NODES_INSTALL.bat
rem    LTX-2-MODELS-NODES_INSTALL.bat /update
rem    LTX-2-MODELS-NODES_INSTALL.bat /force
rem    LTX-2-MODELS-NODES_INSTALL.bat /dryrun
rem    LTX-2-MODELS-NODES_INSTALL.bat /restore
rem
...
:CHOOSE_MODEL
echo(
echo Which LTX-2 quantization?
echo 1) Q4_K_S  – GPUs ^< 12 GB VRAM RECOMMENDED
...
:: log header
call :timestamp TS
echo [%TS%] Starting the safe installer. > "%LOG%"
...
call :handle_node "ComfyUI-LTXVideo"              "https://github.com/Lightricks/ComfyUI-LTXVideo"
...
call :handle_node "ComfyUI-Logic"                 "https://github.com/theUpsider/ComfyUI-Logic"
call :handle_node "comfyui_controlnet_aux"        "https://github.com/Fannovel16/comfyui_controlnet_aux"
call :handle_node "ComfyUI-Custom-Scripts"        "https://github.com/pythongosssss/ComfyUI-Custom-Scripts"
call :handle_node "ComfyUI-Crystools"             "https://github.com/crystian/ComfyUI-Crystools"
call :handle_node "Derfuu_ComfyUI_ModdedNodes"    "https://github.com/Derfuu/Derfuu_ComfyUI_ModdedNodes"
call :handle_node "ComfyUI-MelBandRoFormer"       "https://github.com/kijai/ComfyUI-MelBandRoFormer"
call :handle_node "ComfyLiterals"                 "https://github.com/M1kep/ComfyLiterals"
call :handle_node "comfyui-yaser-nodes"           "https://github.com/YaserJaradeh/comfyui-yaser-nodes"
call :handle_node "ComfyUI-S3-IO"                 "https://github.com/olduvai-jp/ComfyUI-S3-IO"

popd

:models_only
echo(
echo -------- Checking LTX-2 model files --------
pushd models

:: --- Text Encoders ---
call :grab text_encoders\ltx-2-19b-embeddings_connector_dev_bf16.safetensors ^
     "%HF%/ltx-2-19b-embeddings_connector_dev_bf16.safetensors?download=true"

call :grab text_encoders\gemma-3-12b-it-IQ4_XS.gguf ^
     "%HF%/gemma-3-12b-it-IQ4_XS.gguf?download=true"

:: --- VAE ---
call :grab vae\LTX2_audio_vae_bf16.safetensors ^
     "%HF%/LTX2_audio_vae_bf16.safetensors?download=true"

call :grab vae\LTX2_video_vae_bf16.safetensors ^
     "%HF%/LTX2_video_vae_bf16.safetensors?download=true"

:: --- UNet ---
call :grab unet\ltx-2-19b-dev-!MODEL_VERSION!.gguf ^
     "%HF%/ltx-2-19b-dev-!MODEL_VERSION!.gguf?download=true"

:: --- Latent Upscaler ---
call :grab latent_upscale_models\ltx-2-spatial-upscaler-x2-1.0.safetensors ^
     "%HF%/ltx-2-spatial-upscaler-x2-1.0.safetensors?download=true"

:: --- Diffusion ---
call :grab diffusion_models\MelBandRoformer_fp32.safetensors ^
     "%HF%/MelBandRoformer_fp32.safetensors?download=true"
