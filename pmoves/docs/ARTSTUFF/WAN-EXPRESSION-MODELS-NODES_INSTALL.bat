...
rem ----------------------------------------------------------------
rem  WAN 2.2 expression - SAFE node install + model fetch
...
rem
rem  Usage:
rem    WAN-EXPRESSION-MODELS-NODES_INSTALL.bat
rem    WAN-EXPRESSION-MODELS-NODES_INSTALL.bat /update
rem    WAN-EXPRESSION-MODELS-NODES_INSTALL.bat /force
rem    WAN-EXPRESSION-MODELS-NODES_INSTALL.bat /dryrun
rem    WAN-EXPRESSION-MODELS-NODES_INSTALL.bat /restore
rem
...
:: log header
call :timestamp TS
echo [%TS%] Starting WAN22 safe installer. > "%LOG%"
...
call :handle_node "ComfyUI-WanVideoWrapper"       "https://github.com/kijai/ComfyUI-WanVideoWrapper"
call :handle_node "ComfyUI-Impact-Pack"           "https://github.com/ltdrdata/ComfyUI-Impact-Pack"
call :handle_node "ComfyUI-GGUF"                  "https://github.com/city96/ComfyUI-GGUF.git"
call :handle_node "rgthree-comfy"                 "https://github.com/rgthree/rgthree-comfy.git"
call :handle_node "ComfyUI-Easy-Use"              "https://github.com/yolain/ComfyUI-Easy-Use"
call :handle_node "ComfyUI-KJNodes"               "https://github.com/kijai/ComfyUI-KJNodes.git"
call :handle_node "ComfyUI_UltimateSDUpscale"     "https://github.com/ssitu/ComfyUI_UltimateSDUpscale"
call :handle_node "ComfyUI_essentials"            "https://github.com/cubiq/ComfyUI_essentials.git"
call :handle_node "ComfyUI-MagCache"              "https://github.com/Zehong-Ma/ComfyUI-MagCache"
call :handle_node "wlsh_nodes"                    "https://github.com/wallish77/wlsh_nodes.git"
...
call :handle_node "ComfyUI-Frame-Interpolation"   "https://github.com/Fannovel16/ComfyUI-Frame-Interpolation"
call :handle_node "RES4LYF"                       "https://github.com/ClownsharkBatwing/RES4LYF"
call :handle_node "ComfyUI-RMBG"                  "https://github.com/1038lab/ComfyUI-RMBG"
call :handle_node "ComfyUI_tinyterraNodes"        "https://github.com/TinyTerra/ComfyUI_tinyterraNodes"
call :handle_node "was-node-suite-comfyui"        "https://github.com/ltdrdata/was-node-suite-comfyui"

popd

:models_only
echo(
echo -------- Checking WAN 2.2 model files --------
pushd models
