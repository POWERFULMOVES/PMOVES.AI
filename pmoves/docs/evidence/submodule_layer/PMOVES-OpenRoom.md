...
_Generated: 2026-08-22 21:22 UTC_
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `PMOVES-OpenRoom` | yes | `+` | `local` | yes | no | ok | `skip` |

## Findings
- [ERROR] `TOP_LEVEL_DOSSIER_MISSING` `PMOVES-OpenRoom`: Missing top-level required files: ['PMOVES.AI_INTEGRATION.md']
