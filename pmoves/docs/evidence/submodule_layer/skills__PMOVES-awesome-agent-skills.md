...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `skills/PMOVES-awesome-agent-skills` | no | `-` | `skip-uninitialized` | no | yes | ok | `skip` |

## Findings
- [ERROR] `UNINITIALIZED` `skills/PMOVES-awesome-agent-skills`: Submodule is not initialized.
