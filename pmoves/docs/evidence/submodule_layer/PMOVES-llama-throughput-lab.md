...
_Generated: 2026-08-22 21:18 UTC_
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `PMOVES-llama-throughput-lab` | yes | `+` | `local` | yes | no | ok | `skip` |

## Findings
- [ERROR] `TOP_LEVEL_DOSSIER_MISSING` `PMOVES-llama-throughput-lab`: Missing top-level required files: ['PMOVES.AI_INTEGRATION.md']
