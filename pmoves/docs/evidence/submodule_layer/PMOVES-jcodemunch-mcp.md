...
_Generated: 2026-08-22 21:17 UTC_
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `PMOVES-jcodemunch-mcp` | no | `-` | `skip-uninitialized` | no | no | ok | `skip` |

## Findings
- [ERROR] `UNINITIALIZED` `PMOVES-jcodemunch-mcp`: Submodule is not initialized.
