...
_Generated: 2026-08-22 21:20 UTC_
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `PMOVES-moonraker-obico` | no | `-` | `skip-uninitialized` | no | no | ok | `skip` |

## Findings
- [ERROR] `UNINITIALIZED` `PMOVES-moonraker-obico`: Submodule is not initialized.
