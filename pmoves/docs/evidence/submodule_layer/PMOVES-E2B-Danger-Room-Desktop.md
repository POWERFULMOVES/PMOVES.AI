...
_Generated: 2026-08-22 21:14 UTC_
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `PMOVES-E2B-Danger-Room-Desktop` | yes | `+` | `local` | yes | no | ok | `skip` |

## Findings
- [ERROR] `TOP_LEVEL_DOSSIER_MISSING` `PMOVES-E2B-Danger-Room-Desktop`: Missing top-level required files: ['PMOVES.AI_INTEGRATION.md']
