...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `skills/pmoves-fork-repository-skill` | no | `-` | `skip-uninitialized` | no | yes | ok | `skip` |

## Findings
- [ERROR] `UNINITIALIZED` `skills/pmoves-fork-repository-skill`: Submodule is not initialized.
