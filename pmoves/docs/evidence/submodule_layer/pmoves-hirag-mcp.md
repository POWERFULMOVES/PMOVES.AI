...
_Generated: 2026-08-22 21:16 UTC_
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `pmoves-hirag-mcp` | yes | ` ` | `local` | yes | no | ok | `skip` |

## Findings
- [ERROR] `TOP_LEVEL_DOSSIER_MISSING` `pmoves-hirag-mcp`: Missing top-level required files: ['PMOVES.AI_INTEGRATION.md']
