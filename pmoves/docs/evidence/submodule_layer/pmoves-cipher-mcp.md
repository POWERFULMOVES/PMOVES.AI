...
_Generated: 2026-08-22 21:11 UTC_
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `pmoves-cipher-mcp` | no | `-` | `skip-uninitialized` | no | no | ok | `skip` |

## Findings
- [ERROR] `UNINITIALIZED` `pmoves-cipher-mcp`: Submodule is not initialized.
