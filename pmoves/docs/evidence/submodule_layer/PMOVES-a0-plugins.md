...
_Generated: 2026-03-16 05:21 UTC_
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `PMOVES-a0-plugins` | yes | ` ` | `local` | yes | no | ok | `skip` |

## Findings
- [ERROR] `TOP_LEVEL_DOSSIER_MISSING` `PMOVES-a0-plugins`: Missing top-level required files: ['PMOVES.AI_INTEGRATION.md']
