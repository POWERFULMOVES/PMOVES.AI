...
_Generated: 2026-08-22 21:13 UTC_
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `PMOVES-Danger-infra` | yes | ` ` | `local` | yes | no | ok | `skip` |

## Findings
- [ERROR] `TOP_LEVEL_DOSSIER_MISSING` `PMOVES-Danger-infra`: Missing top-level required files: ['PMOVES.AI_INTEGRATION.md']
