...
_Generated: 2026-08-22 21:24 UTC_
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Pmoves-pretext` | yes | ` ` | `local` | yes | no | ok | `skip` |

## Findings
- [ERROR] `TOP_LEVEL_DOSSIER_MISSING` `Pmoves-pretext`: Missing top-level required files: ['PMOVES.AI_INTEGRATION.md']
