...
_Generated: 2026-08-22 21:23 UTC_
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `PMOVES-Pinokio-Ultimate-TTS-Studio` | yes | `+` | `local` | yes | no | ok | `skip` |

## Findings
- [ERROR] `TOP_LEVEL_DOSSIER_MISSING` `PMOVES-Pinokio-Ultimate-TTS-Studio`: Missing top-level required files: ['PMOVES.AI_INTEGRATION.md']
