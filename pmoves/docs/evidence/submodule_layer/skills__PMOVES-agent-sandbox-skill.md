...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `skills/PMOVES-agent-sandbox-skill` | no | `-` | `skip-uninitialized` | no | yes | ok | `skip` |

## Findings
- [ERROR] `UNINITIALIZED` `skills/PMOVES-agent-sandbox-skill`: Submodule is not initialized.
