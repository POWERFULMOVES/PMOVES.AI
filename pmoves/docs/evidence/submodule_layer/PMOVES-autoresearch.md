...
_Generated: 2026-08-22 21:10 UTC_
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `PMOVES-autoresearch` | yes | `+` | `local` | yes | no | ok | `skip` |

## Findings
- [ERROR] `TOP_LEVEL_DOSSIER_MISSING` `PMOVES-autoresearch`: Missing top-level required files: ['PMOVES.AI_INTEGRATION.md']
