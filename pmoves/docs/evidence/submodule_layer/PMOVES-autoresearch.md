...
_Generated: 2026-03-16 05:22 UTC_
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `PMOVES-autoresearch` | no | `-` | `skip-uninitialized` | no | no | ok | `skip` |

## Findings
- [ERROR] `UNINITIALIZED` `PMOVES-autoresearch`: Submodule is not initialized.
