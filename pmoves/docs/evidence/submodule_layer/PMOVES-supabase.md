...
_Generated: 2026-08-22 21:25 UTC_
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `PMOVES-supabase` | yes | `+` | `local` | yes | no | ok | `skip` |

## Findings
- [ERROR] `TOP_LEVEL_DOSSIER_MISSING` `PMOVES-supabase`: Missing top-level required files: ['PMOVES.AI_INTEGRATION.md']
