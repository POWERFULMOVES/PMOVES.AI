...
**Status**: Design Phase
**Version**: 1.0
**Promoted to main**: 2026-04-26 (was stranded in 8 operator/codex worktrees)

> [!NOTE]
> **Engineering architecture & roadmap doc for the Flute voice/TTS layer.**
>
> Flute has three companion docs at three lenses — read whichever matches your need:
>
> - **Engineering Architecture & Roadmap (this file):** 4-tier hierarchy (CLI/BoTZ/AgentZero/Archon), data model, REST + WebSocket API, NATS subjects, voice provider integrations (VibeVoice/Ultimate TTS/Whisper/ElevenLabs), Phase 12a–d milestones, security, dependencies.
> - **Multimodal Vision:** [`FLUTE_VISION_MULTIMODAL.md`](./FLUTE_VISION_MULTIMODAL.md) — POML prompt orchestration, Mangle deductive translation, Qwen-3 Omni captioning, CHIT geometry-bus interface, JAMZ media library, n8n delegation, unified message schema.
> - **Prosodic Synthesis Architecture:** [`../infrastructure/FLUTE_PROSODIC_ARCHITECTURE.md`](../infrastructure/FLUTE_PROSODIC_ARCHITECTURE.md) — boundary type system, ProsodicChunk data structure, BPM-prosodic bridge, parsing algorithm, syllable estimation, audio stitching, TTFS optimization, CHIT voice attribution.
> - **Operational API Reference:** [`.claude/context/flute-gateway.md`](../../../.claude/context/flute-gateway.md) — runtime endpoints, request/response shapes, persona selection.
>
> The well-being-matrix axis (chakra ↔ HRV ↔ BPM ↔ Hz octave) lives in [`AGNOTE4482FLUTE.md`](../AGENTS/AGNOTE4482FLUTE.md).
