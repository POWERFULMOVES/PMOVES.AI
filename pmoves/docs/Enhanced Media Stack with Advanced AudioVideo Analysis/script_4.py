# Create the Entity Extraction Service with Google LangExtract

os.makedirs('entity-service', exist_ok=True)

# Entity Extraction Service main.py
entity_main = '''
...
# Save Entity Extraction Service files
with open('entity-service/main.py', 'w') as f:
    f.write(entity_main)

with open('entity-service/Dockerfile', 'w') as f:
    f.write(entity_dockerfile)

with open('entity-service/requirements.txt', 'w') as f:
    f.write(entity_requirements)

print("✓ Entity Extraction Service created with:")
print("- Google LangExtract integration")
print("- Multiple extraction templates (general, media, music, YouTube)")
print("- Batch processing support")
print("- File upload capabilities")
print("- Transcription data processing")
