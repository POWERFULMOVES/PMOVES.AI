...
**Character count:** 2,399 / 2,600 (measured 2026-08-10 over the paragraph block below, blank lines between paragraphs included — the prior 2,108 figure did not match the text)
