...
rem -------------------------------------------------------------
rem  ComfyUI + QWEN IMAGE EDIT one-click installer      by Aitrepreneur
rem -------------------------------------------------------------

:: ✎  Version bump zone
set "COMFY_VER=v0.3.51"
set "SEVEN_VER=22.01"
...
:CHOOSE_MODEL
echo(
echo Which QWEN IMAGE Edit quantization?
...
call :grab text_encoders\Qwen2.5-VL-7B-Instruct-UD-!MODEL_VERSION!.gguf ^
     "%HF%/Qwen2.5-VL-7B-Instruct-UD-!MODEL_VERSION!.gguf?download=true"	 
...
:: --- UNets ---
call :grab unet\Qwen_Image_Edit-!MODEL_VERSION!.gguf ^
     "%HF%/Qwen_Image_Edit-!MODEL_VERSION!.gguf?download=true"

:: --- LoRAs ---
call :grab loras\Qwen-Image-Lightning-8steps-V1.1.safetensors ^
     "%HF%/Qwen-Image-Lightning-8steps-V1.1.safetensors?download=true"
call :grab loras\Qwen-Image-Lightning-4steps-V1.0.safetensors ^
     "%HF%/Qwen-Image-Lightning-4steps-V1.0.safetensors?download=true"
