# Create the YouTube Downloader Service with yt-dlp

os.makedirs('ytdl-service', exist_ok=True)

# YouTube Downloader Service main.py
ytdl_main = '''
...
# Save YouTube Downloader Service files
with open('ytdl-service/main.py', 'w') as f:
    f.write(ytdl_main)

with open('ytdl-service/Dockerfile', 'w') as f:
    f.write(ytdl_dockerfile)

with open('ytdl-service/requirements.txt', 'w') as f:
    f.write(ytdl_requirements)

print("✓ YouTube Downloader Service created with:")
print("- yt-dlp library integration")
print("- Audio/video download capabilities")
