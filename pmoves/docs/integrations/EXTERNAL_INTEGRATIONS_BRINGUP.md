...
JELLYFIN_DRM_RENDER_NODE=/dev/dri/renderD128   # names the node; override for multi-GPU hosts
JELLYFIN_VAAPI_DEVICE=/dev/dri                 # passthrough SCOPE — whole tree; VAAPI needs the card node too
