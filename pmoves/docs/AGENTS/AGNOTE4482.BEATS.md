...
> **Status 2026-09-10:** the 82-track corpus is BPM/CLAP-enriched (#2279/#2301) and git-tracked at `pmoves/data/beats/soundcloud/darkxside/`; beats are now the human-side third-ref feed (jellyfin-bridge playback → persona profiles). Prosodic BPM lane: `shift-from-bpm` skill → `tokenism.prosodic.bpm.v1`.
