...
- `2026-04-24T16:48Z` CLAIM `4090-CLAUDE` scope: Phase B SITREP rewrite — replace §Agent Lanes Quick Reference expertise-lane framing with capacity-class framing per PMOVES_MOF_ARCHITECTURE.md (PR #1378). Add ≤200-word preamble explaining the framing change. Rename section to §Node Capacity Quick Reference. Branch `docs/sitrep-capacity-classes`. TTL 24h.
