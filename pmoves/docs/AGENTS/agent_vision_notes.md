...
> Raw Claude stream-of-consciousness notes from pre-MOF era. Never structured into normative content.
> Retained for historical reference per operator directive. Do NOT use as authoritative source.
> See `FLUTE_VISION_MULTIMODAL.md` for canonical vision/multimodal spec.
