...
_Generated: 2026-02-15 23:09 UTC_

## Summary
- Total submodules declared: **49**
- Initialized in workspace: **49/49**
- With at least one docs entry point: **49/49**
- Top-level modules with `PMOVES.AI_INTEGRATION.md`: **40/40**
...
| `Pmoves-Health-wger` | `Pmoves-Health-wger` | yes | yes | `Pmoves-Health-wger/PMOVES.AI_INTEGRATION.md`, `Pmoves-Health-wger/README.md` |
| `PMOVES-HiRAG` | `PMOVES-HiRAG` | yes | yes | `PMOVES-HiRAG/PMOVES.AI_INTEGRATION.md`, `PMOVES-HiRAG/README.md` |
| `Pmoves-hyperdimensions` | `Pmoves-hyperdimensions` | yes | yes | `Pmoves-hyperdimensions/PMOVES.AI_INTEGRATION.md` |
| `PMOVES-Jellyfin` | `PMOVES-Jellyfin` | yes | yes | `PMOVES-Jellyfin/PMOVES.AI_INTEGRATION.md`, `PMOVES-Jellyfin/README.md` |
| `Pmoves-Jellyfin-AI-Media-Stack` | `Pmoves-Jellyfin-AI-Media-Stack` | yes | yes | `Pmoves-Jellyfin-AI-Media-Stack/PMOVES.AI_INTEGRATION.md`, `Pmoves-Jellyfin-AI-Media-Stack/README.md` |
| `PMOVES-llama-throughput-lab` | `PMOVES-llama-throughput-lab` | yes | yes | `PMOVES-llama-throughput-lab/PMOVES.AI_INTEGRATION.md`, `PMOVES-llama-throughput-lab/README.md` |
| `PMOVES-MAI-UI` | `PMOVES-MAI-UI` | yes | yes | `PMOVES-MAI-UI/PMOVES.AI_INTEGRATION.md`, `PMOVES-MAI-UI/README.md` |
| `PMOVES-n8n` | `PMOVES-n8n` | yes | yes | `PMOVES-n8n/PMOVES.AI_INTEGRATION.md`, `PMOVES-n8n/README.md` |
| `PMOVES-Open-Notebook` | `PMOVES-Open-Notebook` | yes | yes | `PMOVES-Open-Notebook/PMOVES.AI_INTEGRATION.md`, `PMOVES-Open-Notebook/docs/index.md`, `PMOVES-Open-Notebook/README.md` |
...
| `PMOVES-transcribe-and-fetch` | `PMOVES-transcribe-and-fetch` | yes | yes | `PMOVES-transcribe-and-fetch/PMOVES.AI_INTEGRATION.md`, `PMOVES-transcribe-and-fetch/pmoves-integrations/README.md`, `PMOVES-transcribe-and-fetch/README.md` |
...
| `pmoves/integrations/archon` | `pmoves/integrations/archon` | yes | no | `pmoves/integrations/archon/pmoves-integrations/README.md`, `pmoves/integrations/archon/docs/README.md`, `pmoves/integrations/archon/README.md` |
| `pmoves/vendor/agentgym` | `pmoves/vendor/agentgym` | yes | no | `pmoves/vendor/agentgym/README.md` |
| `pmoves/vendor/agentgym-rl` | `pmoves/vendor/agentgym-rl` | yes | no | `pmoves/vendor/agentgym-rl/README.md` |
| `pmoves/vendor/e2b-desktop` | `pmoves/vendor/e2b-desktop` | yes | no | `pmoves/vendor/e2b-desktop/README.md` |
| `pmoves/vendor/e2b-infra` | `pmoves/vendor/e2b-infra` | yes | no | `pmoves/vendor/e2b-infra/README.md` |
| `pmoves/vendor/e2b-mcp-server` | `pmoves/vendor/e2b-mcp-server` | yes | no | `pmoves/vendor/e2b-mcp-server/README.md` |
| `pmoves/vendor/e2b-spells` | `pmoves/vendor/e2b-spells` | yes | no | `pmoves/vendor/e2b-spells/README.md` |
| `pmoves/vendor/e2b-surf` | `pmoves/vendor/e2b-surf` | yes | no | `pmoves/vendor/e2b-surf/README.md` |
| `research/A2UI` | `research/A2UI` | yes | no | `research/A2UI/docs/index.md`, `research/A2UI/README.md` |
