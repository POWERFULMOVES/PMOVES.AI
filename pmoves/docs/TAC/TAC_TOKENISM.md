...
| Smart contract attribution | Dry-run settlement interface | Contract models, settlement schemas, and Firefly transaction drafts exist; live Firefly/chain execution remains gated |
...
- Gate Firefly live settlement execution behind operator approval, executor identity, and signed recorded/failed NATS publishing
