...
**Target:** Docker Compose v2 (integrated with Docker CLI)
...
1. [Port Binding Best Practices](#port-binding-best-practices)
2. [Network Architecture Patterns](#network-architecture-patterns)
3. [Service Discovery and DNS](#service-discovery-and-dns)
4. [Health Check Patterns](#health-check-patterns)
5. [Security Considerations](#security-considerations)
6. [Docker Compose v2 Features](#docker-compose-v2-features)
