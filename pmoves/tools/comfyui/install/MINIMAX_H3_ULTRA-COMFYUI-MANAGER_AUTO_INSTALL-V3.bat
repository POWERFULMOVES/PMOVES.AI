...
rem -------------------------------------------------------------
rem  ComfyUI + MiniMax H3 one-click installer V3       by Aitrepreneur
rem -------------------------------------------------------------

:: Version bump zone
set "COMFY_VER=v0.33.1"
...
call :clone https://github.com/seesee75-commits/ComfyUI-MiniMaxH3-Director
if exist ComfyUI-MiniMaxH3-Director\requirements.txt "%PY%" -m pip install -r ComfyUI-MiniMaxH3-Director\requirements.txt

call :clone https://github.com/Adudeguyman/ComfyUI-Fantastic-MiniMaxH3-PromptBuilder
if exist ComfyUI-Fantastic-MiniMaxH3-PromptBuilder\requirements.txt "%PY%" -m pip install -r ComfyUI-Fantastic-MiniMaxH3-PromptBuilder\requirements.txt

call :clone https://github.com/BigStationW/ComfyUi-Scale-Image-to-Total-Pixels-Advanced
if exist ComfyUi-Scale-Image-to-Total-Pixels-Advanced\requirements.txt "%PY%" -m pip install -r ComfyUi-Scale-Image-to-Total-Pixels-Advanced\requirements.txt

call :clone https://github.com/aitrepreneur/ComfyUI-MiniMaxH3-T1-Latent
if exist ComfyUI-MiniMaxH3-T1-Latent\requirements.txt "%PY%" -m pip install -r ComfyUI-MiniMaxH3-T1-Latent\requirements.txt

call :clone https://github.com/Aitrepreneur/ComfyUI-H3-Motion-Context-MultiRef-V3
if exist ComfyUI-H3-Motion-Context-MultiRef-V3\requirements.txt "%PY%" -m pip install -r ComfyUI-H3-Motion-Context-MultiRef-V3\requirements.txt

call :clone https://github.com/drozbay/MaskVidExperiments
if exist MaskVidExperiments\requirements.txt "%PY%" -m pip install -r MaskVidExperiments\requirements.txt

call :clone https://github.com/Nekodificador/ComfyUI-NKD-Basic-Tools
if exist ComfyUI-NKD-Basic-Tools\requirements.txt "%PY%" -m pip install -r ComfyUI-NKD-Basic-Tools\requirements.txt

call :clone https://github.com/LBH-123-AI/Comfyui_Minimax_h3_latent_Upscaler
if exist Comfyui_Minimax_h3_latent_Upscaler\requirements.txt "%PY%" -m pip install -r Comfyui_Minimax_h3_latent_Upscaler\requirements.txt
...
call :grab loras\minimax_h3_turbo_v4_step600_ema_pruned_comfyui.safetensors ^
     "%HF%/minimax_h3_turbo_v4_step600_ema_pruned_comfyui.safetensors?download=true"	 
...
call :grab vae\minimax_h3_t1_image_vae_step1597.safetensors ^
     "%HF%/minimax_h3_t1_image_vae_step1597.safetensors?download=true"

:: --- Live Preview ---
call :grab vae_approx\taeh3.safetensors ^
     "%HF%/taeh3.safetensors?download=true"

:: --- Latent Upscaler ---
call :grab latent_upscale_models\minimax_h3_latent_upscaler_3d_fp16.safetensors ^
     "%HF%/minimax_h3_latent_upscaler_3d_fp16.safetensors?download=true"

:: --- Inpainting ---
call :grab checkpoints\sam3.1_multiplex_fp16.safetensors ^
     "%HF%/sam3.1_multiplex_fp16.safetensors?download=true"
