...
rem ----------------------------------------------------------------
rem  MiniMax H3 ULTRA V3 - SAFE node install + model fetch
...
call :handle_node "ComfyUI-MiniMaxH3-Director" "https://github.com/seesee75-commits/ComfyUI-MiniMaxH3-Director"
call :handle_node "ComfyUI-Fantastic-MiniMaxH3-PromptBuilder" "https://github.com/Adudeguyman/ComfyUI-Fantastic-MiniMaxH3-PromptBuilder"
call :handle_node "ComfyUi-Scale-Image-to-Total-Pixels-Advanced" "https://github.com/BigStationW/ComfyUi-Scale-Image-to-Total-Pixels-Advanced"
call :handle_node "ComfyUI-MiniMaxH3-T1-Latent" "https://github.com/aitrepreneur/ComfyUI-MiniMaxH3-T1-Latent"
call :handle_node "ComfyUI-H3-Motion-Context-MultiRef-V3" "https://github.com/Aitrepreneur/ComfyUI-H3-Motion-Context-MultiRef-V3"
call :handle_node "MaskVidExperiments" "https://github.com/drozbay/MaskVidExperiments"
call :handle_node "ComfyUI-NKD-Basic-Tools" "https://github.com/Nekodificador/ComfyUI-NKD-Basic-Tools"
call :handle_node "Comfyui_Minimax_h3_latent_Upscaler" "https://github.com/LBH-123-AI/Comfyui_Minimax_h3_latent_Upscaler"
