-- =============================================================================
-- PMOVES.AI Standard Personas Seed (initdb pipeline)
-- =============================================================================
-- Source: pmoves/db/v5_14_seed_standard_personas.sql
-- Sequence: 17 (after model_registry_seed at 12, agent_threads at 16)
-- Purpose: Seed 8 production-ready persona identities for agent orchestration
--
-- Requires: pmoves_core.personas table (from migration 20250115_persona_agent_creation)
-- Requires: model_providers/models populated (from 12_model_registry_seed.sql)
--
-- Personas reference these model_preference values from the model registry:
--   claude-sonnet-4-5 (Anthropic) — Developer, Creator, Analyst, Tester
--   claude-opus-4-5 (Anthropic)   — Researcher, Coordinator, Security
--   claude-haiku-4-5 (Anthropic)  — Archivist
--
-- Thread Types:
...
--
-- Idempotent: Uses ON CONFLICT (name, version) DO UPDATE
-- =============================================================================
...
-- =============================================================================
-- VERIFICATION (run manually, not during initdb)
-- =============================================================================

-- Verify all personas are seeded correctly:
-- SELECT name, version, thread_type, model_preference, temperature, is_active
-- FROM pmoves_core.personas WHERE version = '1.0' ORDER BY name;
-- Expected: 8 rows (Developer, Researcher, Creator, Analyst, Archivist, Coordinator, Tester, Security)
