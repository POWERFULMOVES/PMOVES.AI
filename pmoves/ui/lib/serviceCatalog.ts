...
export const SERVICE_CATALOG: ServiceDefinition[] = [
  ...
  },
  {
    slug: 'open-notebook',
    title: 'Open Notebook',
    summary: 'Branded notebook UI/API stack with SurrealDB persistence and TensorZero routing.',
    category: 'integration',
    color: 'cyan',
    endpoints: [
      { name: 'Web UI', port: '8503', path: '/', type: 'ui' },
      { name: 'API', port: '5055', path: '/', type: 'api' },
    ],
    external: true,
    capabilities: ['Notebook workbench', 'Provider bootstrap', 'SurrealDB-backed notes'],
    dependencies: ['tensorzero-gateway'],
  },
  {
    slug: 'firefly',
    title: 'PMOVES Wealth (Firefly III)',
    summary: 'Personal finance portal integrated into the PMOVES external stack.',
    category: 'integration',
    color: 'cyan',
    endpoints: [
      { name: 'Web UI', port: '8082', path: '/', type: 'ui' },
      { name: 'API', port: '8082', path: '/api/v1', type: 'api' },
    ],
    external: true,
    capabilities: ['Transaction tracking', 'Budgeting', 'Finance automation hooks'],
  },
  {
    slug: 'wger',
    title: 'PMOVES Health (Wger)',
    summary: 'Fitness and workout tracking portal bundled as a PMOVES external integration.',
    category: 'integration',
    color: 'cyan',
    endpoints: [
      { name: 'Web UI', port: '8000', path: '/', type: 'ui' },
      { name: 'API', port: '8000', path: '/api/v2', type: 'api' },
    ],
    external: true,
    capabilities: ['Workout planning', 'Progress logs', 'Health automation hooks'],
  },
  {
    slug: 'jellyfin',
    title: 'Jellyfin',
    summary: 'Media hub for ingestion, playback, and PMOVES creator pipeline validation.',
    category: 'integration',
    color: 'cyan',
    endpoints: [
      { name: 'Web UI', port: '8096', path: '/web/index.html', type: 'ui' },
      { name: 'API', port: '8096', path: '/System/Info/Public', type: 'api' },
    ],
    external: true,
    capabilities: ['Media library', 'Playback validation', 'Bridge integration'],
  },
  {
    slug: 'jellyfin-ai-dashboard',
    title: 'Jellyfin AI Overlay',
    summary: 'Overlay dashboard + API gateway for AI media enrichment workflows.',
    category: 'integration',
    color: 'cyan',
    endpoints: [
      { name: 'Dashboard', port: '8400', path: '/', type: 'ui' },
      { name: 'API Gateway', port: '8300', path: '/', type: 'api' },
      { name: 'Jellyfin AI', port: '9096', path: '/web/index.html', type: 'ui' },
    ],
    external: true,
    capabilities: ['Audio/metadata enrichment', 'Overlay observability', 'Creator workflow handoff'],
    dependencies: ['jellyfin', 'tensorzero-gateway'],
  },
  {
    slug: 'invidious',
    title: 'Invidious',
