  ...
  return (
    <html lang="en" className="dark">
      ...
      <body className="min-h-screen bg-void text-ink-primary antialiased">
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-cata-cyan focus:text-void focus:rounded-md focus:font-medium focus:outline-none"
        >
