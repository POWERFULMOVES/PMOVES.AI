        ...
        <main style={{ padding: 24, display: "grid", gap: 24 }}>
          ...
          {!threadId ? (
            <section style={{ opacity: 0.7 }}>
              Enter a thread identifier to load messages, views, snapshots, and groups. Use `make supa-start` then run the
              seed script if you need demo content.
            </section>
          ) : (
            <div style={{ display: "grid", gap: 24 }}>
              <section style={{ display: "grid", gap: 12 }}>
                ...
                {selectedMessageId && layers.length === 0 && !loading && (
                  <p style={{ opacity: 0.7 }}>This message has no saved views yet. Drag, position, and save a new layout.</p>
                )}
              </section>
