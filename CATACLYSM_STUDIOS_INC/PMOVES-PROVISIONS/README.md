...
> **Distribution note:** Shipping this bundle to another machine? Pair it with
> `README_APPLY.txt` (co-located here and in `docs/provisioning/`) for the
> canonical copy instructions generated by the PMOVES mini CLI.
